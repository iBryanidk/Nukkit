    ...
    public void init(ChunkManager level, NukkitRandom random) {
        ...
        this.populators = ImmutableList.of(
                new PopulatorOre(STONE, new OreType[]{
                        ...
                        new OreType(Block.get(BlockID.IRON_ORE), 15, 9, 0, 64),
                        new OreType(Block.get(BlockID.REDSTONE_ORE), 8, 8, 0, 16),
                        new OreType(Block.get(BlockID.LAPIS_ORE), 8, 8, 0, 16),
                        new OreType(Block.get(BlockID.GOLD_ORE), 10, 9, 0, 32),
                        new OreType(Block.get(BlockID.DIAMOND_ORE), 8, 8, 0, 16),
